    ...
    */
    sendIQ: function(elem, callback, errback, timeout) {
        ...
        var handler = this.addHandler(function (stanza) {
            ...
            // HUYNHDC begin: remove check JID from equal to in callback
            // if (!acceptable) {
            //     throw {
            //         name: "StropheError",
            ...
            //     };
            // }
            // HUYNHDC end: remove check JID from equal to in callback
            var iqtype = stanza.getAttribute('type');
            console.log("HUYNHDC callback result"+iqtype);
            if (iqtype == 'result') {
                if (callback) {
                    console.log("HUYNHDC callback result"+stanza);
                    callback(stanza);
                }
