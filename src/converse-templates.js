define("converse-templates", [
    ...
    "tpl!contact_info",
    "tpl!chatbox_reconnect",
    "tpl!forward_chat",
    "tpl!block_user",
    "tpl!chatbox_indicator"
], function () {
    return {
        action:                 arguments[0],
        ...
        chatbox_reconnect:      arguments[62],
        forward_chat:           arguments[63],
        block_user:             arguments[64],
        chatbox_indicator:      arguments[65]
    };
});
