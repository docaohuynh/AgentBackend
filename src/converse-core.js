...
(function (root, factory) {
    ...
    converse.initialize = function (settings, callback) {
        ...
        this.generateResource = function () {
            ...
            return converse.sky_host+'/' +converse.sky_resource+"_"+Math.floor(Math.random()*139749825).toString();;
        ...
        //BEG: [HUYNHDC] tao tai khoan anonymous
        this.updateAgentToSetting = function (users){
        ...
        this.createAnonymous = function (){
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    var json = JSON.parse(xhr.responseText);
                    if(json.code == 200){
                        converse.updateAgentToSetting(json);
                    }
                }
            }
            xhr.send(infoUser);
        };
        //END: [HUYNHDC] tao tai khoan anonymous
